...
Database.then(async (db) => {
    ...
    proffyValue = { 
        ...
        whatsapp : 83936354654, 
        bio : "Entusiasta das melhores tecnologias de quimica avancada.<br><br>Apaixonado por explodir coisas em laboratorio e por mudar a vida das pessoas atraves de experiencias. Mais de 200.000 pessoas ja passaram por uma das minhas explosoes.",
    }
    classValue = {
        subject: 1,
        cost: "20"
